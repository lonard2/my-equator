...
export function TaxBatchGenerateModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
      <div className="bg-neutral-900 border border-neutral-800 rounded-2xl w-full max-w-2xl overflow-hidden shadow-2xl animate-in zoom-in-95 duration-150">
        {/* Modal Header */}
        ...
        <div className="p-5 space-y-4 max-h-[70vh] overflow-y-auto">
          ...
          <div className="bg-neutral-950 border border-neutral-800 rounded-xl p-3.5 grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
            <div>
              ...
              <select
                ...
                className="w-full bg-neutral-900 border border-neutral-800 rounded-lg px-2.5 py-1.5 text-xs text-neutral-200 focus:outline-none focus:border-red-600"
              >
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between text-xs">
              <button
                ...
                className="text-neutral-400 hover:text-neutral-200 flex items-center gap-1.5 font-medium"
              >
            ...
            <div className="bg-neutral-950 border border-neutral-800 rounded-xl overflow-hidden divide-y divide-neutral-800/60 max-h-60 overflow-y-auto">
              {loading ? (
                ...
                <div className="p-8 text-center text-xs text-neutral-500">
                  <CheckCircle2 className="w-6 h-6 mx-auto mb-2 text-emerald-500/50" />
                  <p>
                    {isId
                ...
                unbilledOrders.map((order) => {
                  ...
                  return (
                    <div
                      ...
                      className={`p-3 text-xs flex items-center justify-between cursor-pointer hover:bg-neutral-900/60 transition-colors ${
          ...
          {selectedOrderIds.length > 0 && (
            <div className="bg-red-950/20 border border-red-900/40 rounded-xl p-3.5 flex items-center justify-between text-xs">
              <div>
        ...
        {/* Modal Footer */}
        <div className="p-4 border-t border-neutral-800 flex items-center justify-end gap-2.5 bg-neutral-950/80">
          <button
            onClick={onClose}
