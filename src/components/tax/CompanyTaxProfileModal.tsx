  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in duration-150">
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="company-tax-profile-title"
        className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl w-full max-w-lg overflow-hidden shadow-2xl animate-in zoom-in-95 duration-150"
      >
        {/* Header */}
        <div className="p-4 border-b border-neutral-200 dark:border-neutral-800 flex items-center justify-between bg-neutral-50 dark:bg-neutral-950/80">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 id="company-tax-profile-title" className="text-sm font-bold text-neutral-900 dark:text-neutral-100">
        ...
        <form onSubmit={handleSave} className="p-5 space-y-4 max-h-[75vh] overflow-y-auto">
          ...
          {/* Nama Perusahaan */}
          <div>
            <label htmlFor="tax-company-name" className="text-xs font-semibold text-neutral-700 dark:text-neutral-300 block mb-1">
            ...
            <input
              ...
              className="w-full bg-neutral-50 dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 rounded-lg px-3 py-2 text-xs text-neutral-900 dark:text-neutral-100 focus:outline-none focus:border-red-600 focus:ring-1 focus:ring-red-600"
            />
          </div>
          ...
          <div>
            <div className="flex justify-between items-center mb-1">
              <label htmlFor="tax-company-npwp" className="text-xs font-semibold text-neutral-700 dark:text-neutral-300">
                NPWP 16 Digit
              </label>
              <span
                className={`text-[11px] font-mono ${
                  npwpValidation.isValid ? "text-emerald-600 dark:text-emerald-400" : "text-amber-600 dark:text-amber-400"
                }`}
              >
            ...
            <input
              ...
              className="w-full bg-neutral-50 dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 rounded-lg px-3 py-2 text-xs font-mono text-neutral-900 dark:text-neutral-100 focus:outline-none focus:border-red-600 focus:ring-1 focus:ring-red-600"
            />
          </div>
          ...
          <div>
            <div className="flex justify-between items-center mb-1">
              <label htmlFor="tax-company-nitku" className="text-xs font-semibold text-neutral-700 dark:text-neutral-300">
                NITKU 22 Digit (Nomor Identitas Tempat Kegiatan Usaha)
              </label>
              <span
                className={`text-[11px] font-mono ${
                  nitkuValidation.isValid ? "text-emerald-600 dark:text-emerald-400" : "text-amber-600 dark:text-amber-400"
                }`}
              >
          ...
          <div className="grid grid-cols-3 gap-3">
            <div>
              <label htmlFor="tax-company-kpp-code" className="text-xs font-semibold text-neutral-700 dark:text-neutral-300 block mb-1">
                Kode KPP
              </label>
              <input
                id="tax-company-kpp-code"
                type="text"
                value={kppCode}
            ...
            <div className="col-span-2">
              <label htmlFor="tax-company-kpp-name" className="text-xs font-semibold text-neutral-700 dark:text-neutral-300 block mb-1">
                Nama Kantor Pelayanan Pajak (KPP)
              </label>
              <input
                id="tax-company-kpp-name"
                type="text"
                value={kppName}
          ...
          <div>
            <label htmlFor="tax-company-address" className="text-xs font-semibold text-neutral-700 dark:text-neutral-300 block mb-1">
              {isId ? "Alamat Terdaftar PKP" : "Registered Tax Address"}
            </label>
            <textarea
              id="tax-company-address"
              rows={2}
              required
              value={taxAddress}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label htmlFor="tax-company-signer-name" className="text-xs font-semibold text-neutral-700 dark:text-neutral-300 block mb-1">
                {isId ? "Nama Penandatangan Faktur" : "Authorized Signer Name"}
              </label>
              <input
                id="tax-company-signer-name"
                type="text"
                required
                value={signatoryName}
            ...
            <div>
              <label htmlFor="tax-company-signer-role" className="text-xs font-semibold text-neutral-700 dark:text-neutral-300 block mb-1">
                {isId ? "Jabatan Penandatangan" : "Signer Role / Title"}
              </label>
              <input
                id="tax-company-signer-role"
                type="text"
                required
                value={signatoryRole}
          ...
          {/* Footer inside form */}
          <div className="pt-2 flex justify-end gap-2.5 border-t border-neutral-200 dark:border-neutral-800">
            <button
              type="button"
              onClick={onClose}
