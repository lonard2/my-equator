...
export function SptMasaSummaryCard({
  ...
  return (
    <div className="bg-neutral-900/90 border border-neutral-800 rounded-xl p-5 shadow-lg relative overflow-hidden">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 pb-4 mb-4 border-b border-neutral-800">
        ...
        {summary.unbilledOrdersCount > 0 && (
          <div className="flex items-center gap-2.5 bg-amber-950/40 border border-amber-800/60 rounded-lg px-3 py-1.5 text-xs text-amber-300">
